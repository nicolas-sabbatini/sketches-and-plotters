...
function draw() {
  ...
  for (let i = 0; i < 4; i++) {
    ...
    line(
      p1[0] * offSetZ + offSetX,
      p1[1] * offSetZ + offSetY,
      p2[0] * offSetZ + offSetX,
      p2[1] * offSetZ + offSetY
    );
    line(
      p1[0] * offSetZ + offSetX,
      p1[1] * offSetZ + offSetY,
      p3[0] * offSetZ + offSetX,
      p3[1] * offSetZ + offSetY
    );
    line(
      p3[0] * offSetZ + offSetX,
      p3[1] * offSetZ + offSetY,
      p4[0] * offSetZ + offSetX,
      p4[1] * offSetZ + offSetY
    );
  }
  // Move Rectangle
